// app/components/PrivacyPolicyContent.js
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 text-lg leading-7">
              At <span className="font-semibold">Divevclave</span>, we are committed to protecting the privacy and security of our users. This Privacy Policy outlines the types of information we collect, how it is used, and the steps we take to protect it.
            </p>
          </section>
